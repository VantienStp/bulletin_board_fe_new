...
export default function Sidebar({ onLogout }) {
    ...
    const mainMenu = [
        ...
        { href: "/admin/tasks", label: "Tasks", icon: "fa-list-check" },
        { href: "/admin/calendar", label: "Calendar", icon: "fa-calendar" },
        { href: "/admin/team", label: "Team", icon: "fa-users" },
        { href: "/admin/project", label: "Project", icon: "fa-diagram-project" },
        { href: "/admin/analytics", label: "Analytics", icon: "fa-chart-simple" },
        { href: "/admin/blog", label: "Blogs", icon: "fa-chart-simple" },
    ];
    ...
    return (
        <aside className="w-full h-full bg-white px-4 py-4 flex flex-col rounded-l-2xl">
            {/* Logo */}
